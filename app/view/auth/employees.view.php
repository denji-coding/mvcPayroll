                                                ...
                                                <td class="p-3 align-middle font-medium">
                                                    <div class="flex items-center space-x-2">
                                                        <span class="relative flex shrink-0 overflow-hidden rounded-full h-12 w-12">
                                                            ...
                                                            <?php else: ?>
                                                                <img class="aspect-square h-full w-full" src="..\public\assets\image\default_user_image.svg" alt="Default Photo">
                                                            <?php endif; ?>
                                                        </span>
                                                    </div>
                                                </td>
...
<div class="modal fade" id="viewEmployeeModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="viewEmployeeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title text-success text-lg fw-semibold"><i class="bi bi-info-circle me-2"></i>Employee Details</h5>
        ...
        <div class="modal-body">
            ...
            <div class="col-12">
                <h6 class="text-success mt-3 text-sm"><strong>Address</strong></h6>
            ...
            <button type="button" 
                        class="btn btn-outline-success me-2 w-[90px] editBtn" 
                        data-id="<?= $employee['employee_no'] ?>" 
                        data-bs-toggle="modal" 
            ...
            <button 
                    type="button"  id="modalDeleteBtn"
                    class="btn btn-danger deleteBtn" 
                    data-id="<?= $employee['id'] ?>">  <!-- use `id` here -->
...
<!-- <div class="modal fade" id="deleteEmployeeModal" tabindex="-1" aria-labelledby="deleteEmployeeModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form id="deleteEmployeeForm" method="POST" action="index.php?payroll=employees">
      <input type="hidden" name="employee_id" id="employeeIdToDelete">
      <div class="modal-content">
        <div class="modal-header">
